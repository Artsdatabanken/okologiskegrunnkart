...
docker run --rm -v /home:/home bjreppen/gdal:latest ogr2ogr -f "PostgreSQL" PG:"dbname=postgres host=172.17.0.2 user=postgres password=veldighemmelig" $PWD/nin.geojsonl  -lco SCHEMA=import -nln nin -lco OVERWRITE=YES

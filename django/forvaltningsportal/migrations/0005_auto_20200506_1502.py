...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('forvaltningsportal', '0004_underkartlag'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hovedkartlag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sublag', to='forvaltningsportal.Kartlag')),
            ],
        ),

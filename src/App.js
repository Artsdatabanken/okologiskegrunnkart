...
class App extends React.Component {
        ...
        for (let i = 0; i < propertyData.length; i++) {
          ...
          backend.hentAdresseSok(knr, gnr, bnr).then(sok => {
            ...
            if (i === countEnd) {
              ...
              this.selectAdress(newSok, matrikkel, sortedGeom);
            }
          });
        }
      }
  ...
  selectAdress = (sok, matrikkel, sortedGeom) => {
    let address = null;
